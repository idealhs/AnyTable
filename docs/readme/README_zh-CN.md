...
> 直接在表头旁完成日常排序和筛选操作。
>
> ![快速排序和筛选截图](./assets/feature-quick-sort-filter.png)

### 高级排序

> 通过多列优先级、排序方向和类型识别完成更复杂的排序规则。
>
> ![高级排序截图](./assets/feature-advanced-sort.png)

### 高级筛选

> 用嵌套条件组构建更灵活的复杂筛选流程。
>
> ![高级筛选截图](./assets/feature-advanced-filter.png)

### 统计功能

> 为当前表格视图追加统计结果，并始终贴近原始数据展示。
>
> ![统计功能截图](./assets/feature-statistics.png)

### 导出 CSV

> 一键导出当前可见表格数据。
>
> ![导出 CSV 截图](./assets/feature-export-csv.png)
